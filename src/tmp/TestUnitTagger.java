...
public class TestUnitTagger {
    public static void main(String[] args) throws Exception {
        CFGParser4Header parser = new CFGParser4Header(XMLConfigs.load(new FileReader("lib/unit-tagger/unit-tagger-configs.xml")));
...
//        FeatureBasedParser parser = new FeatureBasedParser(XMLConfigs.load(new FileReader("conf/unit-tagger-configs.xml")), null);
        ...
        System.out.println("====================================================================================================");
        QuantityCatalog catalog = new QuantityCatalog((org.w3c.dom.Element) null);
        System.out.println(catalog.getUnitFromBaseName("ton of coal equivalent").getParentQuantity().getConcept());
    }
}

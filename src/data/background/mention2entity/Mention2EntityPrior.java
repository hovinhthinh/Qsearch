...
public class Mention2EntityPrior {
    private static final String PRIOR_PATH = "m2ePrior_wikipages+wikitables+wikilinks.case-sensitive_tokenized.gz";
    ...
    public Mention2EntityPrior(int minMention2EntityFreq, int nTopKeptCandidateEntities) {
        ...
        int afterPruned = 0;
        int total = 0;
        for (String line : FileUtils.getResourceLineStream(PRIOR_PATH, "UTF-8")) {

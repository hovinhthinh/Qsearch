...
public class QKBCResult {
    ...
    public static void calculateStats(String inputFile) {
        ...
        System.out.println(String.format("%12s%12s%12s%16s%16s%12s", "iter", "#facts", "prec.", "recall(x1e-2)", "ext.", "#noise"));
        int it = 0;
        do {
            int currentIt = ++it;
            ...
            System.out.println(String.format("%12d%12d%12.3f%16.3f%16s%12d", it, nFacts, prec, recall,

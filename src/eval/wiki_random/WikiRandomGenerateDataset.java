...
public class WikiRandomGenerateDataset {
    public static void main(String[] args) {
        ...
        for (String line : FileUtils.getLineStream("eval/wiki_random/wiki_links-random.txt", "UTF-8")) {
            tableIdHash.add(line);
        }
        SelfMonitor m = new SelfMonitor("Monitor", -1, 10);
        m.start();
        PrintWriter out = FileUtils.getPrintWriter("eval/wiki_random/wiki_random_data.gz", "UTF-8");

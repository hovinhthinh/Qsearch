...
public class WikiDiffGenerateDataset {
    public static void main(String[] args) {
        ...
        for (String line : FileUtils.getLineStream("eval/table/exp_1/wiki_diff/table.id.txt", "UTF-8")) {
            tableIdHash.add(line);
        }
        SelfMonitor m = new SelfMonitor("Monitor", -1, 10);
        m.start();
        PrintWriter out = FileUtils.getPrintWriter("eval/table/exp_1/wiki_diff/table_data.gz", "UTF-8");

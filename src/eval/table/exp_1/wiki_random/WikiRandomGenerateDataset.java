...
public class WikiRandomGenerateDataset {
    public static void main(String[] args) {
        ...
        for (String line : FileUtils.getLineStream("eval/table/exp_1/wiki_random/wiki_links-random.txt", "UTF-8")) {
            tableIdHash.add(line);
        }
        SelfMonitor m = new SelfMonitor("Monitor", -1, 10);
        m.start();
        PrintWriter out = FileUtils.getPrintWriter("eval/table/exp_1/wiki_random/wiki_random_data.gz", "UTF-8");

...
public class TypeLiftingRestrictor {
    ...
    public boolean entityIsInProximity(Int2IntLinkedOpenHashMap type2DistanceMapForTargetEntity) {
        for (Int2IntMap.Entry e : Int2IntMaps.fastIterable(type2DistanceMapForTargetEntity)) {
